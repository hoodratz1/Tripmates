...
class InviteFriendsCh extends React.Component {
  constructor(props) {
    super(props);
    ...
    return (
      <div className="backdrop">
        <div id="modal">
          ...
          <input name="friendName" placeholder="朋友帳號" type ="text" onChange={e => this.setState({friend: e.target.value})}/>

          <button id="secondary" onClick={this.addFriendClick}>+</button>

          {this.state.userNotFound ? (
            <div className="errorMsg">帳號不存在</div>
          ) : null}

          <button id="modalButton" onClick={(e) => {this.props.onAddTripClick(e, this.state.friends)}}>
            提交
          </button>
          <a href="/" onClick={(e) => this.props.onClose(e)}>取消</a>
        </div>
      </div>
    )
  }
...
export default InviteFriendsCh;
