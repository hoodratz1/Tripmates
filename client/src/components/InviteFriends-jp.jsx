...
class InviteFriendsJp extends React.Component {
  constructor(props) {
    super(props);
      ...
      <div className="backdrop">
        <div id="modal">
          ...
          {this.state.userNotFound ? (
            <div className="errorMsg">このユーザーは存在しません。</div>
          ) : null}

          <button id="modalButton" onClick={(e) => {this.props.onAddTripClick(e, this.state.friends)}}>
            旅行を作る
          </button>
          <a href="/" onClick={(e) => this.props.onClose(e)}>キャンセル</a>
        </div>
      </div>
    )
  }
...
export default InviteFriendsJp;
